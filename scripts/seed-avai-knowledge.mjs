...
import { loadAvAiSeed, seedAvAiKnowledge, verifyAvAiKnowledge } from '../src/servers/knowledge.js';
...
const result = await seedAvAiKnowledge(seed, { overwrite: !process.argv.includes('--no-overwrite') });
